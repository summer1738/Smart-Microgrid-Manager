  ...
  return (
    <div>
      ...
      <p style={{ color: '#94a3b8', fontSize: '0.9rem', maxWidth: 720 }}>
        Change the system location and PV nameplate in <Link to="/settings">Settings</Link>.
      </p>
      ...
      >
        {forecastChart && (
          <div style={{ background: '#1e293b', padding: '1rem', borderRadius: 8 }}>
            ...
            <p style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: 0 }}>
              Hourly shortwave × array capacity (see weather settings).
            </p>
            <MultiLineChart
        ...
        {historyChart && (
          <div style={{ background: '#1e293b', padding: '1rem', borderRadius: 8 }}>
            ...
            <p style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: 0 }}>
              Trapezoidal integration of <code>pv_readings.power_kw</code> per day
            </p>
            <MultiLineChart
      ...
      {!forecastChart && !historyChart && (
        <p style={{ marginTop: '1.5rem', color: '#94a3b8' }}>No forecast or history data yet.</p>
      )}
    </div>
  )
}
